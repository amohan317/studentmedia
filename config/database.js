...
connection=mySqlDB.createConnection({
   ...
   port:"3306",
   user:"root",
   password:"paunchycoyote2699$2604",
   database:"studmedia"
});
...
executeSchema=()=>{
   ...
   connection.query("CREATE TABLE STUD_REG_USER(EMAIL_ID VARCHAR(200) PRIMARY KEY,USER_NAME VARCHAR(200),PASSWORD VARCHAR(200),FIRST_NAME VARCHAR(300),MIDDLE_NAME VARCHAR(300),LAST_NAME VARCHAR(300),GENDER VARCHAR(100),MOBILE_NO VARCHAR(11));",errHandle);
